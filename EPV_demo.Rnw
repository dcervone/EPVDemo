...
<<shot_bases, cache=TRUE, fig.width=6, fig.height=2.4, fig.lp='fig:', fig.pos='h!', fig.align='center', fig.cap='Shot-taking spatial bases; this plot is the same as Figure 6 of the paper (though the ordering is different).'>>=
