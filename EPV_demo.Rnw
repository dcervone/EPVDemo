...
opts_chunk$set(size="footnotesize", cache=F, message=F,
...
% Define "touch ID" for each player touch sequence
% Define "possession ID" starting with first touch of new team and continuing until clock stop or new team possession
